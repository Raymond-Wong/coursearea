...
logging.getLogger().setLevel(logging.INFO if DEBUG else logging.INFO)
...
SECRET_KEY = 'u30m&0rb+n#+4(w$(#c!9&8db*&fni-tnhl8fwagl^*wyu)-yo'
...
ROOT_URLCONF = 'coursearea.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'coursearea.wsgi.application'
